...
% Last Modified by GUIDE v2.5 15-May-2020 18:15:17
...
table(row+1,1)=str2double(get(handles.custId,'string'));
table(row+1,2)=str2double(get(handles.drugId,'string'));
table(row+1,3)=str2double(get(handles.disc,'string'));
set(handles.add,'string',table);
end
